...
const channel = ref<{ id: string, name: string, description: string } | null>(null)
...
const subscribe = async () => {
  await channelStore.subscribeToChannel(channel.value!.id)
}

const unsubscribe = async () => {
  await channelStore.unsubscribeFromChannel(channel.value!.id)
}
</script>
